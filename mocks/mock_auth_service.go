...
// Source: github.com/aliparlakci/armut-backend-assessment/services (interfaces: Authenticator,PasswordHasher)
...
func (m *MockAuthenticator) Authenticate(arg0 context.Context, arg1, arg2 string) (bool, error) {
	m.ctrl.T.Helper()
